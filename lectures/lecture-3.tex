...
\begin{figure}[htpb]
	...
	\caption{The figure shows a cross-section of two pixels on a CCD. Each pixel
...
\begin{figure}[htpb]
	...
	\caption{Process of moving electrons to the register. The potential across the gates
