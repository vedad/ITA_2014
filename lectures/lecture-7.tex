...
%{\end{list}}
%\begin{document}
%\setcounter{section}{6} No need for merging
...
\begin{figure}[h!]
%  \hfil\psfig{file=path-length.eps,width=0.9\textwidth}\hfil
	\centering
...
\begin{figure}[th!]
%  \hfil\psfig{file=cornu.eps,width=0.7\textwidth}\hfil
	\centering
...
\subsection{A simple model (with exercises)}
...
\begin{figure}[h]
  \centering
%	\psfig{file=seeing_global.eps,width=0.9\textwidth}
...
\begin{figure}[h]
  \centering
%	\psfig{file=wavefront_rn.eps,width=0.9\textwidth}
...
\begin{figure}[h]
%  \hfil\psfig{file=AO_live_display.eps,width=0.9\textwidth}\hfil
	\centering
